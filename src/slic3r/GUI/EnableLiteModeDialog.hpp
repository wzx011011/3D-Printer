#ifndef slic3r_GUI_EnableLiteModeDialog_hpp_
#define slic3r_GUI_EnableLiteModeDialog_hpp_
...
wxDECLARE_EVENT(EVT_LITE_MODE_CONFIRM, wxCommandEvent);
wxDECLARE_EVENT(EVT_LITE_MODE_CANCEL, wxCommandEvent);

class EnableLiteModeDialog : public DPIDialog
{
public:
    enum ButtonStyle {
        ONLY_CONFIRM = 0,
