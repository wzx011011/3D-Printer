#ifndef WipeTowerCrealityCFS_
#define WipeTowerCrealityCFS_
...
class WipeTowerCrealityCFS
{
public:
    // Construct ToolChangeResult from current state of WipeTowerCrealityCFS and WipeTowerWriterCrealityCFS.
    // WipeTowerWriterCrealityCFS is moved from !
    WipeTower::ToolChangeResult construct_tcr(WipeTowerWriterCrealityCFS& writer, 
								   bool priming,
                                   size_t old_tool, 
    ...
    WipeTowerCrealityCFS(const PrintConfig& config,
