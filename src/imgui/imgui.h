...
namespace ImGui
{
    ...
    IMGUI_API bool          BBLBeginCombo(const char *label, const char *preview_value, ImGuiComboFlags flags = 0, float contentWidth = 0.0f, float offset = 0.0f);
    // No Hide anything after a '##' string
    IMGUI_API bool CPBBLBeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags = 0, float contentWidth = 0.0f, float offset = 0.0f);
    ...
    IMGUI_API bool          DragScalarV2(const char* label, ImGuiDataType data_type, void* p_data, float v_speed = 1.0f, const void* p_min = NULL, const void* p_max = NULL, const char* format = NULL, ImGuiSliderFlags flags = 0);
